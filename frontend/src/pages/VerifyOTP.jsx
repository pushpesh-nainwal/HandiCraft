        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full px-3 py-2 border border-[#E6DBC8] rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#A8572E]/30 focus:border-[#A8572E] text-center text-2xl tracking-widest"
              placeholder="123456"
            />
          </div>
