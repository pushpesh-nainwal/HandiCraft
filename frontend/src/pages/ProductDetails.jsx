...
import { ArrowLeft, ShoppingCart, Heart, Leaf, Truck, Shield, CheckCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              {/* Eco Features */}
              <div className="mb-6">
                <h2 className="text-lg font-semibold text-gray-900 mb-3">Eco Features</h2>
        ...
        <div className="mt-12">
          ...
          <div className="text-center py-8 bg-white rounded-xl shadow-md">
            <p className="text-gray-600 mb-4">Discover more products in this category</p>
            <Link
